...
class BookYouInvestIn(models.Model):
    user_invested_in = models.ForeignKey(EludeUser, related_name='user_i_am_investing_in')
    book_invested_in = models.ForeignKey(Book)
    investors = models.ManyToManyField(EludeUser, related_name='investors')
    amount_invested_in = models.CharField(verbose_name="Amount invested in book", default=None, max_length=250)
    additional_information = models.TextField(verbose_name="Additional information", default=None)
    price = models.CharField(default=None, max_length=250)


class YourBookThatWasInvestedIn(models.Model):
    book_invested_in = models.ForeignKey(Book)
    investors = models.ManyToManyField(EludeUser)
    amount_invested_in_your_book = models.CharField(verbose_name="Amount invested in book", default=None, max_length=250)
    additional_information = models.TextField(verbose_name="Additional information", default=None)
    price = models.CharField(default=None, max_length=250)
